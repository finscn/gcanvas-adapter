...
tbplay.onTouchStart(eventHandlerFactory('pointerdown'))
tbplay.onTouchMove(eventHandlerFactory('pointermove'))
tbplay.onTouchEnd(eventHandlerFactory('pointerup'))
tbplay.onTouchCancel(eventHandlerFactory('pointercancel'))
